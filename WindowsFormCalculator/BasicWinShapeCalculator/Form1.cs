...
namespace BasicWinShapeCalculator
{
    public partial class Form1 : Form
    {
        ...
        private void buttonCalculate_Click(object sender, EventArgs e)
        {
            ...
            if (rbTriangle.Checked && rbArea.Checked)
            {
            ...
            else if (rbSquare.Checked && rbArea.Checked)
            {
                double a = double.Parse(tbFirstInput.Text);
                area = a * a;
                shape = rbSquare.Text;
            }
            else if (rbRectangle.Checked && rbArea.Checked)
            {
                double a = double.Parse(tbFirstInput.Text);
            ...
            else if (rbTriangle.Checked && rbPerimeter.Checked)
            {
                double a = double.Parse(tbFirstInput.Text);
                double b = double.Parse(tbSecondInput.Text);
            ...
            else if (rbSquare.Checked && rbPerimeter.Checked)
            {
                double a = double.Parse(tbFirstInput.Text);
                perimeters = a + a + a + a;
                shape = rbSquare.Text;
            }
            else if (rbRectangle.Checked && rbPerimeter.Checked)
            {
                double a = double.Parse(tbFirstInput.Text);
                double b = double.Parse(tbSecondInput.Text);
                perimeters = (a + b) * 2;
            ...
            else if (rbCircle.Checked && rbArea.Checked)
            {
